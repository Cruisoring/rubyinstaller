...
module DevKitInstaller
  ...
  MSYS = OpenStruct.new(
    ...
    :files => {
      :url_1 => [
        'msys2-runtime-2.1.0.16359.acadff9-1-i686.pkg.tar.xz',
        ...
        'libnettle-3.1-1-i686.pkg.tar.xz',
